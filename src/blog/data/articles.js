const articles = [{
    ...
    "content": [
        ...
        "Alright...brief timeout...picture taken. On the one year of this article I'll need to remind myself to write thta article....slackbot perhaps. How about a calendar event for now.",
